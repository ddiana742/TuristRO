  ...
  public  class ObiectiveViewModel
    {
        ...
        public ObiectiveViewModel()
        {
            ...
            {
                 new ObiectiveModels() {id=1, Nume = "Cascada Cailor", Descriere = "situată în apropiere de stațiunea turistică Borșa", Imagine = "cascada.jpg" },
                 new ObiectiveModels() {id=2, Nume = "Lacul Sfanta ", Descriere = "în singurul lac vulcanic din Europa Centrală", Imagine = "sfana.jpg" },
                ...
                new ObiectiveModels() {id=4, Nume = "Delta Dunării ", Descriere = "este cea mai bine conservată deltă de pe continentul european", Imagine = "delta.jpg" },
                ...
                new ObiectiveModels() {id=8, Nume = "Salina Turda", Descriere = "un adevarat muzeu de istorie a mineritului în sare, la 30 de kilometri de Cluj și la câteva sute de metri sub pământ", Imagine = "turda.jpg" },
                 ...
                 new ObiectiveModels() {id=11, Nume = "Mocănița", Descriere = "Una dintre cele mai importante valori culturale şi tehnice ale țării, Mocănița de la Vişeu de Sus este ultima cale ferată forestieră cu abur din lume", Imagine = "mocanita.jpg" }
